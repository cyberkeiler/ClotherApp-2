...
public class UpdateProfile extends Activity {
    ...
    //Setzt die Icon Schrift f�r das Symbol
    TextView RegisterIcon = (TextView) findViewById(R.id.textView2);
    RegisterIcon .setTypeface(MainMenu.fontawesome);

    //TODO: Erstelle Textfeldabfrage usw. plausibilit�tspr�fung und erstelle angand dieser einen User
    ...
    updateProfile.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (isPasswordValid(passwordAsString) && isPasswordIdentical(passwordAsString, passwordConfirmAsString)) {
                Toast.makeText(getApplicationContext(), "Passw�rter stimmen nicht �berein", Toast.LENGTH_SHORT);
                password.setText("");
            ...
            if (result){
                Toast.makeText(getApplicationContext(), "Profil ge�ndert!", Toast.LENGTH_LONG).show();
            }
            else {
                Toast.makeText(getApplicationContext(), "Profil�nderung FAILED", Toast.LENGTH_LONG).show();
            }
            finish();
        }
    });
